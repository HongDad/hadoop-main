 ...
 *
 *  NameNode既充当目录名称空间管理器，又充当Hadoop DFS的“索引节点表”。任何DFS部署中都只有一个NameNode *。
 * （好，除非有第二个备份/故障转移NameNode或使用联邦时。）
 *
